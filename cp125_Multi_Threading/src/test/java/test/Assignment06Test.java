...
public final class Assignment06Test {
	...
	public void setUp() {
		...
		staffConsultant = new StaffConsultant(new Name("Coder", "Kalvin"), CODER_INITIAL_PAY_RATE,
				INITIAL_SICK_LEAVE_HOURS, INITIAL_VACATION_HOURS);
		consultantList.add(staffConsultant);
		consultantList.add(new StaffConsultant(new Name("Architect", "Amber", "K."), ARCHITECT_INITIAL_PAY_RATE,
				INITIAL_SICK_LEAVE_HOURS, INITIAL_VACATION_HOURS));
		consultantList.add(new StaffConsultant(new Name("Tester", "Teddy", "B."), TESTER_INITIAL_PAY_RATE,
				INITIAL_SICK_LEAVE_HOURS, INITIAL_VACATION_HOURS));
		consultantList.add(new StaffConsultant(new Name("Engineer", "Ernie"), ENGINEER_INITIAL_PAY_RATE,
				INITIAL_SICK_LEAVE_HOURS, INITIAL_VACATION_HOURS));
